...
__attribute__((inline)) uint8_t map(int x, int in_min, int in_max, uint8_t out_min, uint8_t out_max)
{
  return (x - in_min) * (out_max - out_min) / (in_max - in_min) + out_min;
}

__attribute__((inline)) void setup(void)
{
    TRISDbits.RD0 = 0;
    TRISDbits.RD1 = 0;
    TRISDbits.RD2 = 0;
...
__attribute__((inline)) void error(int code)
{
...
__attribute__((inline)) void start_status()
{
    LATDbits.LATD5 = 1;
}
...
__attribute__((inline)) void send_data()
{
    for(int i=0;i<14;++i)
    {
...
__attribute__((inline)) void actuate()
{
...
__attribute__((inline)) void timedReading_ISR(void)
{
...
void main(void)
{
    ...
    send_pad();
    uint8_t x = 0;
    TMR2_SetInterruptHandler (timedReading_ISR);
    (INTCONbits.GIE = 1);
    (INTCONbits.PEIE = 1);
